...
class Molecule(System):
    ...
    def coupling_strength_dyson(
        ...
        Notes
        -----
        - coupling strength = C * Psi(r)**2, with `Psi` being Dyson orbital wavefunction and `r` the position of center of tip.
        ...
        This is only an approximation, to obtain values of the expected order of magnitude.
        """
